...
[![latest](https://img.shields.io/badge/latest-0.1.5-d8eb34)](https://crates.io/crates/neva)
...
```toml
[dependencies]
neva = { version = "0.1.5", features = ["client-full"] }
...
```toml
[dependencies]
neva = { version = "0.1.5", features = ["server-full"] }
tokio = { version = "1", features = ["full"] }
```
